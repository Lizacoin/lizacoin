// Copyright (c) 2017 The lizacoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("lizacoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("lizacoin-smsg-pow"); // Make this thread recognisable
